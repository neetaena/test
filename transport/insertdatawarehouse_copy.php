...
?>
	...
	<center><font color="#000000" face="angsana new"><h1><b>ก๊อปปี้ข้อมูลการขนส่ง</b></h1></center></font>
		...
		print("<table align=\"center\" style=\"margin-bottom: 15px;\">");
			...
			print("<tr class=\"body_table\">");
				...
				print("</td>");
					...
					$not_show = array(6,7,17,19,20,22,21,23,24);
...
//----------------------------------------------------------------- ไม้พื้น ---------------------------------------------------------					
			...
			<?php
				...
				print("<br><input type = \"submit\" name = \"summit\" value = \"Copy ข้อมูล\" style = \"width:40mm;height:8mm;empty-cells: show;font-family:angsana new;font-size:18px;\">");
				print("</td>");
				print("</tr>");
	?>
	</form>
