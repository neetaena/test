...
<body>
	<?php
	$marking_id =$_GET['marking_id'];
$get_mark= getlist("SELECT * FROM production_marking WHERE marking_id='$marking_id'");
	    if(!empty($_POST['summit']))
	    {
	       ...
	       $product_id = $_POST['product_id'];
	        $mark_name = $_POST['mark_name'];
	                ...
	                $sql = query("UPDATE production_marking SET mark_name='$mark_name',product_id='$product_id' WHERE marking_id='$marking_id'");
	   ...
	   print("<form action = \"\" name = \"import_data\" method = \"POST\">");
	    print("<table style=\"width:50%;\" align=\"center\" border='0'>");
	    	...
	    	print("</tr>");
	  		print("<tr style=\"text-align:center;\">");
		        print("<td>");
		            ...
		            print("</td>");
		            print("<td>");
		           $_POST['product_id'] = empty($_POST['product_id']) ? $get_mark[0]['product_id'] : $_POST['product_id'];
	    	...
	    	print("<td>");
	    		...
	    		print("</td>");
	    		print("<td>");
		           $_POST['mark_name'] = empty($_POST['mark_name']) ? $get_mark[0]['mark_name'] : $_POST['mark_name'];
