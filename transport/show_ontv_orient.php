...
<table bgcolor = "#FFFFFF" border = "0" cellspacing = "0" cellpadding = "0" align = "center" valign = "middle">
	...
	<tr>
	<td colspan=6 class="body_table" style="font-size: 35px; text-align: center;">ตารางการจัดส่งวันที่ <?php print(printShortSlateThaiDate($_POST['datestart'])); ?>
	</td>
		
	</tr>
	<tr align = "center">

	<td class="body_table" style="font-size: 16px; width:15%; text-align: center;"><b>
		ทะเบียนรถ
	</td>
	...
	<td class="body_table" style="font-size: 16px; width:30%; text-align: center;"><b>
		หมายเหตุ
	</td>
	...
	{
		print("<td class=\"body_table\" style=\"background-color: #66a6f5; font-size:24px;\">");
...
<META HTTP-EQUIV='Refresh' CONTENT = '180;URL=show_ontv_orient.php'>
