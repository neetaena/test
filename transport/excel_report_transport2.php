...
header('Content-Disposition: attachment; filename="ใบสั่งงานขนส่ง2.xls"');#ชื่อไฟล์
...
$product_id = $_GET['product_id'];
    ...
    ?>
        <table  bgcolor = "#FFFFFF" border = "0" cellspacing = "0" cellpadding = "2" align = "center" valign = "middle" style="width:280mm;empty-cells: show;">
            <tr>
                <td align = "center" style = "width:30mm;empty-cells: show;font-family:angsana new;font-size:20px;" colspan="13"><b>
            ...
            <tr>
                <td align = "left" style = "width:30mm;empty-cells: show;font-family:angsana new;font-size:20px;" colspan="13"><b>
                    <?php
    ...
    $get_type = getlist("SELECT * FROM production_order as po inner join type_production as tp on product_id=id_production WHERE $where_data  group by product_id ");
            ...
            {
                $m = 1;
                $get_new = getlist("SELECT * FROM production_order as po inner join type_production as tp on product_id=id_production WHERE data_number ='".$getdata1[$i]['data_number']."'");
                $total_quantity = 0;
                $total_court=0;
                $total_q = 0;
    ...
    ?>      
                        ...
                        ?>
                            <td align = "center"  style = "empty-cells: show;font-family:angsana new;font-size:14px;"><!-- หมายเหตุ -->
                                <?php  //print $get_new[$g]['note']; 
    ...
    function footer()
    {
        ...
        print("<tr style=\"border:0px;\">");
            print("<td colspan=\"3\" style=\"border:0px;text-align:center;\">");
                print("<br>....................................................<br>");
                print("ผู้ทำใบสั่งงาน");
            print("</td>");

            print("<td colspan=\"2\" style=\"border:0px;text-align:center;\">");
                print("<br>....................................................<br>");
                print("ผู้ตรวจสอบ");
            print("</td>");

            print("<td colspan=\"4\" style=\"border:0px;text-align:center;\">");
                print("<br>....................................................<br>");
                print("ผู้อนุมัติ");
            print("</td>");
