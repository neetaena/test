    ...
    print("<tr >");
            ...
            for($i=0;$i<sizeof($getdata);$i++){
                ...
                print("<td style=\"width:15mm;\" class=\"body_table\">");
                    ...
                    print printShortNumDate($getdata[$i]['crate_date']); //เลขที่ใบสั่งขาย
                    //print $getdata[$i]['delivery_date']; //ทดสอบ
                print("</td>");
                print("<td style=\"width:15mm;\" class=\"body_table\">");
                    //print $getdata[$i]['delivery_date']; //วันกำหนดส่ง
                    print printShortNumDate($getdata[$i]['delivery_date']);
                print("</td>");
                ...
                $getdata[$i]['country']=iconv("tis-620", "utf-8", $getdata[$i]['country']);
        ...
        print number_format($q,2);
                ...
                print("<td style=\"width:15mm;\" class=\"body_table\">");
                 $getdata[$i]['sell_name']=iconv("tis-620", "utf-8", $getdata[$i]['sell_name']);             
               ...
               if($note1 !== FALSE || $note2 !== FALSE || $note3 !== FALSE)
               {
