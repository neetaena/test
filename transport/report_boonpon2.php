...
print("<div class=\"container\">");
	...
	for($d=0;$d<sizeof($getDriver);$d++)
	{
		...
		for($i=0;$i<$DateNum;$i++){
			...
			//print("SELECT * FROM production_order as p JOIN insertdata_transport  as i ON p.boonpon_id = i.boonpon_id WHERE delivery_date = '".$cut_new_date[0]."' AND i.nameDriver = '".$getdriver_name[0]['id_driver']."' GROUP BY p.boonpon_id");
