...
<link rel="stylesheet" href="css/jquery-ui.css">
  	<script src="jquery/jquery-ui.js"></script>
		...
		<tr>
			...
			<td align = "left">
				...
				<?php
						...
						print("<input type = \"text\" name = \"place_id\" id=\"place_id\" value = \"".$_POST['place_id']."\" style = \"width:50mm;height:10mm;empty-cells: show;font-family:angsana new;font-size:20px;\" onkeydown=\"if (event.keyCode == 13) { this.form.submit(); return false; }\" onchange = \"this.form.submit();\" class='serach_driver'>");
		...
		<tr>
			...
			<?php
				print("<input   type = \"button\" name = \"summit\" value = \"ยืนยัน\" style=\"width:50mm;empty-cells: show;font-family:angsana new;font-size:22px;\"  onclick = \"window.open('report_boonpon2_main.php?datein=".$_POST['datein']."&dateout=".$_POST['dateout']."&department=1&namedriver=".$get_driver[0]['id_driver']."') \" target=\"_BLANK\">");
			?>
			</td>
		</tr>
		</table>
