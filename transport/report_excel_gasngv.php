		...
		//---------------------------------------------------------------สถานที่จัดส่ง---------------------------------------------------------------
					...
					//---------------------------------------------------------------ประเภทรถ---------------------------------------------------------------
							print("<td class='font-style' style='text-align:center;'>");
								...
								$check_data = getlist("SELECT * FROM gas_ngv WHERE boonpon_id='".$boonpon_id_data[$i]."' ");
								if(!empty($check_data)){
									print("<a onclick = \"window.open('edit/edit_gas_ngv.php?boonpon_id=".$boonpon_id_data[$i]."&data_number=".$get_data[0]['data_number']."' , '','nenuber=no,toorlbar=no,location=no,scrollbars=no, status=no,resizable=no,width=700,height=400,top=45 ,left=250') \" style=\"cursor:pointer;color:#000;\">".number_format($check_data[0]['credit'],2)."</a> ");
								}else{
									print("<a class='excel' onclick = \"window.open('edit/edit_gas_ngv.php?boonpon_id=".$boonpon_id_data[$i]."&data_number=".$get_data[0]['data_number']."' , '','nenuber=no,toorlbar=no,location=no,scrollbars=no, status=no,resizable=no,width=700,height=400,top=45 ,left=250') \" style=\"cursor:pointer;color:#43ad04;\">เพิ่ม</a> ");
								}
							...
							print("<td class='font-style' style='text-align:center;'>");
								...
								if(!empty($check_data)){
									print("<a onclick = \"window.open('edit/edit_gas_ngv.php?boonpon_id=".$boonpon_id_data[$i]."&data_number=".$get_data[0]['data_number']."' , '','nenuber=no,toorlbar=no,location=no,scrollbars=no, status=no,resizable=no,width=700,height=400,top=45 ,left=250') \" style=\"cursor:pointer;color:#000;\">".number_format($check_data[0]['cash'],2)."</a> ");
								}else{
									print("<a class='excel' onclick = \"window.open('edit/edit_gas_ngv.php?boonpon_id=".$boonpon_id_data[$i]."&data_number=".$get_data[0]['data_number']."' , '','nenuber=no,toorlbar=no,location=no,scrollbars=no, status=no,resizable=no,width=700,height=400,top=45 ,left=250') \" style=\"cursor:pointer;color:#43ad04;\">เพิ่ม</a> ");
								}
							...
							print("<td class='font-style' style='text-align:center;'>");
								if(!empty($check_data)){
									print("<a onclick = \"window.open('edit/edit_gas_ngv.php?boonpon_id=".$boonpon_id_data[$i]."&data_number=".$get_data[0]['data_number']."' , '','nenuber=no,toorlbar=no,location=no,scrollbars=no, status=no,resizable=no,width=700,height=400,top=45 ,left=250') \" style=\"cursor:pointer;color:#000;\">".$check_data[0]['num_of_paper']."</a> ");
								}else{
									print("<a class='excel' onclick = \"window.open('edit/edit_gas_ngv.php?boonpon_id=".$boonpon_id_data[$i]."&data_number=".$get_data[0]['data_number']."' , '','nenuber=no,toorlbar=no,location=no,scrollbars=no, status=no,resizable=no,width=700,height=400,top=45 ,left=250') \" style=\"cursor:pointer;color:#43ad04;\">เพิ่ม</a> ");
								}
							...
							print("<td class='font-style' style='text-align:center;'>");
								if(!empty($check_data)){
									print("<a onclick = \"window.open('edit/edit_gas_ngv.php?boonpon_id=".$boonpon_id_data[$i]."&data_number=".$get_data[0]['data_number']."' , '','nenuber=no,toorlbar=no,location=no,scrollbars=no, status=no,resizable=no,width=700,height=400,top=45 ,left=250') \" style=\"cursor:pointer;color:#000;\">".$check_data[0]['note']."</a> ");
								}else{
									print("<a class='excel' onclick = \"window.open('edit/edit_gas_ngv.php?boonpon_id=".$boonpon_id_data[$i]."&data_number=".$get_data[0]['data_number']."' , '','nenuber=no,toorlbar=no,location=no,scrollbars=no, status=no,resizable=no,width=700,height=400,top=45 ,left=250') \" style=\"cursor:pointer;color:#43ad04;\">เพิ่ม</a> ");
								}	
